...
class MigrationTriggerDisableCommand extends AbstractMigrationTriggerCommand
{
    /**
     * Arguments
     */
    ...
    {
        $this->setName('migration:trigger:disable')
            ->setDescription('Disable migration trigger.')
            ->setDefinition([
                new InputArgument(
